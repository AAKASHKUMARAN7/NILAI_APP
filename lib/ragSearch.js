// Nilai — Adaptive RAG Search Engine v2
...
console.log(`[Nilai RAG] Knowledge base: ${constitutionalData.length} constitutional + ${mdLawEntries.length} MD law entries = ${allKnowledgeData.length} total`);
...
const SYNONYM_MAP = {
  ...
  // State Governance
  'governor': ['state head', 'constitutional head', 'raj bhavan', 'Article 153', 'Article 163'],
  'chief minister': ['CM', 'state executive', 'chief minister', 'Article 164', 'council of ministers'],
  'state assembly': ['vidhan sabha', 'legislative assembly', 'MLA', 'state legislature', 'Article 170'],
  'vidhan sabha': ['state assembly', 'legislative assembly', 'MLA', 'state legislature'],
  'vidhan parishad': ['legislative council', 'MLC', 'upper house state', 'Article 169'],
  'mla': ['state assembly', 'legislative assembly', 'vidhan sabha', 'member'],
  'panchayat': ['local body', 'gram panchayat', 'Article 243', 'rural governance', 'sarpanch'],
  'sarpanch': ['panchayat', 'village head', 'gram panchayat', 'pradhan', 'Article 243'],
  'municipality': ['nagar palika', 'municipal corporation', 'urban local body', 'Article 243P', 'mayor'],
  'mayor': ['municipal corporation', 'urban governance', 'city', 'municipality'],
  'collector': ['district collector', 'district magistrate', 'DM', 'administration', 'revenue'],

  // Parliamentary Procedure
  'bill': ['legislation', 'law', 'parliament', 'act', 'amendment', 'Article 107', 'proposed law'],
  'budget': ['finance', 'annual financial statement', 'Article 112', 'appropriation', 'money bill'],
  'money bill': ['finance bill', 'Article 110', 'lok sabha', 'tax', 'budget'],
  'ordinance': ['executive legislation', 'Article 123', 'Article 213', 'temporary law', 'president'],
  'speaker': ['lok sabha', 'presiding officer', 'Article 93', 'parliamentary'],
  'no confidence': ['floor test', 'majority', 'government', 'parliament', 'opposition'],
  'question hour': ['parliament', 'accountability', 'session', 'question', 'minister'],

  // Finance & Taxation
  'gst': ['goods and services tax', 'taxation', 'indirect tax', 'Article 246A', 'GST council', '101st amendment'],
  'income tax': ['direct tax', 'taxation', 'Article 265', 'no tax without law'],
  'finance commission': ['tax devolution', 'Article 280', 'centre state finance', 'grants'],
  'cag': ['comptroller auditor general', 'Article 148', 'audit', 'government accounts', 'expenditure'],
  'consolidated fund': ['government fund', 'Article 266', 'spent only by parliament'],

  // Territory & States
  'union territory': ['UT', 'Article 239', 'territory', 'administration', 'lieutenant governor'],
  'statehood': ['formation of state', 'Article 3', 'new state', 'reorganization'],
  'article 370': ['jammu kashmir', 'special status', 'revoked', 'abrogated', 'reorganisation act 2019'],
  'scheduled area': ['fifth schedule', 'tribal area', 'governor powers', 'PESA'],
  'sixth schedule': ['autonomous district', 'tribal council', 'northeast', 'self governance'],

  // Tribunals & Commissions
  'tribunal': ['quasi judicial', 'Article 323A', 'Article 323B', 'dispute resolution', 'CAT', 'NGT'],
  'nhrc': ['national human rights commission', 'human rights', 'complaint', 'rights violation'],
  'ncw': ['national commission women', 'women rights', 'sexual harassment', 'complaint'],
  'ncpcr': ['child rights', 'national commission protection child rights', 'children', 'POCSO'],
  'upsc': ['civil services', 'Article 315', 'recruitment', 'public service commission', 'IAS'],
  'ngt': ['national green tribunal', 'environment', 'pollution', 'environmental justice'],
  'lokpal': ['anti corruption', 'ombudsman', 'lokayukta', 'corruption complaint'],

  // Language 
  'hindi': ['official language', 'Article 343', 'Devanagari', 'rashtrabhasha'],
  'language': ['linguistic', 'mother tongue', 'Article 29', 'Article 350A', 'eighth schedule'],
  'mother tongue': ['linguistic minority', 'primary education', 'Article 350A', 'language rights'],

  // Situations & Practical
  'what should i do': ['situation', 'rights', 'remedy', 'approach', 'file', 'complaint'],
  'help': ['assist', 'support', 'remedy', 'solution', 'guidance', 'helpline'],
  'victim': ['aggrieved', 'affected', 'suffering', 'harmed', 'wronged', 'rights violation'],
  'situation': ['scenario', 'case', 'circumstance', 'problem', 'issue', 'facing'],
  'complaint': ['grievance', 'FIR', 'petition', 'file', 'report', 'approach'],
  'emergency': ['urgent', 'immediate', 'crisis', 'critical', 'danger', 'threat', 'helpline'],

  // More common terms
  'landlord': ['tenant', 'rent', 'eviction', 'lease', 'property', 'housing'],
  'builder': ['real estate', 'RERA', 'flat', 'apartment', 'construction', 'delay', 'property'],
  'neighbour': ['nuisance', 'encroachment', 'boundary', 'noise', 'property', 'dispute'],
  'passport': ['travel', 'visa', 'movement', 'Article 21', 'Article 19', 'citizenship'],
  'aadhaar': ['identity', 'biometric', 'UIDAI', 'privacy', 'Article 21', 'unique id'],
  'pension': ['retirement', 'gratuity', 'provident fund', 'old age', 'social security'],
  'disability': ['divyang', 'differently abled', 'RPwD Act', 'Article 41', 'equal opportunity'],
  'transgender': ['NALSA', 'third gender', 'gender identity', 'Article 14', 'Article 21', 'TG Act'],
  'lgbtq': ['homosexual', 'gay', 'lesbian', 'bisexual', 'Navtej', 'Section 377', 'Article 21'],
  'bail': ['release', 'custody', 'detention', 'arrested', 'Article 21', 'Article 22'],
  'writ': ['habeas corpus', 'mandamus', 'certiorari', 'prohibition', 'quo warranto', 'Article 32', 'Article 226'],
  'fundamental rights': ['Part III', 'Article 12', 'Article 32', 'enforceable', 'rights'],
  'dpsp': ['directive principles', 'Part IV', 'Article 36', 'welfare state', 'non justiciable'],
  'fundamental duties': ['Article 51A', 'Part IVA', 'citizens duty', 'obligation'],
  'preamble': ['sovereign', 'socialist', 'secular', 'democratic', 'republic', 'justice', 'liberty', 'equality', 'fraternity'],
  'amendment': ['Article 368', 'constitutional change', 'modification', 'special majority'],
  'basic structure': ['Kesavananda', 'unamendable', 'fundamental features', 'judicial review'],
};
...
function calculateScore(query, doc, expandedTokens) {
  ...
  // 8. Category boost — context-aware to avoid false matches
  // IMPORTANT: Words like "court" should NOT blindly boost Landmark Cases
  // when the user is describing a criminal situation
  const criminalPatterns = /kill|murder|assault|attack|stab|shoot|rob|theft|steal|rape|molest|kidnap|drug|accident|hit.?and.?run|cheat|fraud|forgery|bribe|corrupt|extort/i;
  const isCriminalQuery = criminalPatterns.test(query);
  ...
  // Only boost Landmark Cases when the query is actually about cases/judgments, NOT criminal situations
  if (!isCriminalQuery) {
    categoryBoosts['case|judgment|verdict|court'] = 'Landmark Cases';
    categoryBoosts['supreme court|high court|judiciary|judge|writ'] = 'Judiciary';
  } else {
    // For criminal queries, boost procedural/rights content instead
    categoryBoosts['punishment|sentence|penalty|offence|crime|criminal'] = 'Procedural Rights';
    // Only boost judiciary if explicitly about courts/judges, not just the word "court"
    if (/\b(judiciary|judge|high court|supreme court|writ)\b/i.test(query)) {
      categoryBoosts['supreme court|high court|judiciary|judge|writ'] = 'Judiciary';
    }
  }
